...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.craiovadata.android.sunshine.utilities.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.craiovadata.android.sunshine.utilities.GlideOptions().apply(toSet));
    }
  }
}
