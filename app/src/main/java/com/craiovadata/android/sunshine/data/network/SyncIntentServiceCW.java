 ...
 * screen.
 */
public class SyncIntentServiceCW extends IntentService {
    private static final String LOG_TAG = SyncIntentServiceCW.class.getSimpleName();

    public SyncIntentServiceCW() {
        super("SyncIntentServiceCW");
        Log.d(LOG_TAG, "Intent Service Current Weather constructor");
    }

    @Override
    protected void onHandleIntent(Intent intent) {
        Log.d(LOG_TAG, "Intent service started current weather");
